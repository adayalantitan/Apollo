<%@ Page Language="C#" MasterPageFile="~/App_MasterPages/ApolloSearchHorizSplit.master" AutoEventWireup="true" CodeFile="sales_aged_revenue_flash.aspx.cs" Inherits="Apollo.sales_sales_aged_revenue_flash" Title="Flash | Titan 360" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="reportCriteriaPanel" Runat="Server">    
    <script type="text/javascript" language="javascript">        
        ...
        function ValidateAging() {
            if ($get("<%=textAgingDate.ClientID %>").value == "") { alert("Please enter an Aging Date."); return false; }
            var agingDate = new Date($get("<%=textAgingDate.ClientID %>").value);
            //javascripts months are 0-indexed
            if (agingDate < new Date(2009, 10, 17)) {
                alert("Aging Date must be >= 11/17/2009");
                return false;
            }
            $get("<%=generalSearchOptions.ClientID %>").style.display = "none";
            return true;
        }
    ...
    <div style="margin-bottom:10px" id="optionsHeader" runat="server">   
        ...
        <asp:HiddenField ID="isAging" runat="server" />
        <asp:HiddenField ID="isRefreshing" runat="server" />
    ...
    <asp:UpdatePanel ID="reportSelectionUpdPnl" runat="server" UpdateMode="Conditional">            
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="runFlashAging" />
        </Triggers>
        <ContentTemplate>
            <div id="agingOptions" style="text-align:center;margin:10px auto;">
                <div style="margin:0 auto;width:500px !important">
                    <div style="float:left;margin-right:10px;">
                        <asp:Label ID="labelMessage" runat="server" />
                    </div>
                    <div style="float:left;margin-right:10px;margin-top:5px;">
                        <asp:TextBox ID="textAgingDate" runat="server" Width="130px" style="text-align:right" />
                        <ajax:MaskedEditExtender ID="textAgingDateMaskedEditExtender" runat="server" TargetControlID="textAgingDate"
                            AcceptAMPM="true" MaskType="DateTime" Mask="99/99/9999 99:99:99" InputDirection="LeftToRight"
                            AutoComplete="true" />
                    </div>
                    <div style="float:left;margin-top:5px;">
                        <asp:LinkButton ID="runFlashAging" runat="server" style="cursor:pointer" 
                            CssClass="search_filter_options" Text="Age Flash" OnClientClick="return ValidateAging();" 
                            onclick="runFlashAging_Click" />                    
                    </div>
                    <div style="clear:both;"></div>
                </div>
            </div>
        ...
        <div class="horizontalSearchCriteriaArea">
            ...
            <div style="float:left;width:30%;text-align:left;">                
                <ul class="horizontalSearchFilters" style="width:100% !important;">
                    <li>
                        <div>
                            <div class="horizontalSearchFilterLeftColumn">Contracts Entered From:</div>
                            <div class="horizontalSearchFilterRightColumn">
                                <asp:TextBox ID="textEnteredFrom" runat="server" Width="133px" />
                    ...
                    <li>
                        <div>
                            <div class="horizontalSearchFilterLeftColumn">Contracts Entered Thru:</div>
                            <div class="horizontalSearchFilterRightColumn">
                                <asp:TextBox ID="textEnteredThru" runat="server" Width="133px" />
                    ...
                    <li>
                        <div>
                            <div class="horizontalSearchFilterLeftColumn">Contracts Starting From:</div>
                            <div class="horizontalSearchFilterRightColumn">
                                <asp:TextBox ID="textStartingFrom" runat="server" Width="133px" />
                    ...
                    <li>
                        <div>
                            <div class="horizontalSearchFilterLeftColumn">Contracts Starting To:</div>
                            <div class="horizontalSearchFilterRightColumn">
                                <asp:TextBox ID="textStartingTo" runat="server" Width="133px" />
                    ...
                    <li>
                        <div>
                            <div class="horizontalSearchFilterLeftColumn">Billing From:</div>
                            <div class="horizontalSearchFilterRightColumn">
                                <asp:TextBox ID="textBillingFrom" runat="server" Width="133px" />
                    ...
                    <li>
                        <div>
                            <div class="horizontalSearchFilterLeftColumn">Billing To:</div>
                            <div class="horizontalSearchFilterRightColumn">
                                <asp:TextBox ID="textBillingTo" runat="server" Width="133px" />
    ...
    <div id="generalSearchOptions" style="margin-top:5px;display:block;" runat="server">
        <div class="horizontalSearchCriteriaArea">
            <div style="float:left;width:30%;text-align:left;">                
...
<asp:Content ID="Content2" ContentPlaceHolderID="reportListPanel" Runat="Server">
    <div align="center" class="flashTable" runat="server" id="flashResultsTable">
