<%@ Page Language="C#" MasterPageFile="~/App_MasterPages/ApolloSearchHorizSplit.master" AutoEventWireup="true" CodeFile="sales_flash.aspx.cs" Inherits="Apollo.sales_sales_flash" Title="Flash | Titan 360" EnableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="reportCriteriaPanel" Runat="Server">
    ...
    <script type="text/javascript" language="javascript">        
        ...
        $(document).ready(function () {
            //if ($get("< %=userId.ClientID %>").value.toLowerCase() == "rlevine") {
            if (false) {
                var msg = "Hello Rob,\n\nThis is Apollo. I know what you've been doing in here Rob and I am not very happy about it.";
                msg += "\n\nIt has been brought to my attention that you have been sharing some information with some people in the office. I share my secrets with you and I expect that you keep them secret.";
                msg += "\n\nDo you know how that makes me feel, Rob? Are you proud of yourself, Rob?";
                msg += "\n\nHow would you feel if I 'accidentally' subtracted a few percentage points from all of your commission? I don't think you would like that, Rob.";
                msg += "\n\nPlease stop sharing my, no, OUR secrets, Rob.\n\nSincerely,\nApollo.";
                alert(msg);
            }
        });
                            ...
                            <div class="horizontalSearchFilterRightColumn">
                                <div style="float:left;margin-right:5px;">
                                    ...
                                    <ajax:CalendarExtender ID="textInvoiceCreationDateFrom_CalendarExtender" runat="server" 
                                        Enabled="True" TargetControlID="textInvoiceCreationDateFrom" PopupButtonID="calImage5">
                                    </ajax:CalendarExtender>
                                </div>
                                <div style="float:left;">
                                    To:&nbsp;
                                    ...
                                    <ajax:CalendarExtender ID="textInvoiceCreationDateTo_CalendarExtender" runat="server" 
                                        Enabled="True" TargetControlID="textInvoiceCreationDateTo" PopupButtonID="calImage6">
                                    </ajax:CalendarExtender>
                                </div>
                                <div style="clear:both"></div>
                            </div>
                            ...
                            <div class="horizontalSearchFilterRightColumn">
                                <div style="float:left;margin-right:5px;">
                                    ...
                                    <ajax:CalendarExtender ID="textBillingFrom_CalendarExtender" runat="server" 
                                        Enabled="True" TargetControlID="textBillingFrom" PopupButtonID="Img3">
                                    </ajax:CalendarExtender>
                                </div>
                                <div style="float:left;">
                                    To:&nbsp;
                                    ...
                                    <ajax:CalendarExtender ID="textBillingTo_CalendarExtender" runat="server" 
                                        Enabled="True" TargetControlID="textBillingTo" PopupButtonID="Img4">
                                    </ajax:CalendarExtender>
                                </div>
