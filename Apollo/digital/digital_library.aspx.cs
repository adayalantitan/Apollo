...
namespace Apollo
{
    ...
    public partial class digital_digital_library : System.Web.UI.Page
    {

        #region Member variables
        /// <summary>TBD</summary>
        public const string SCREEN_NAME = "digital_library";
        #endregion
        ...
        public void ClearFilters()
        {
            ...
            checkBestOfPhotos.Checked = false;
            ...
            radioConsolidated.Checked = false;
            radioNonConsolidated.Checked = true;
            advertiser.Id.Text = "";
            advertiser.Name.Text = "";
            conAdvertiser.Id.Text = "";
            conAdvertiser.Name.Text = "";
            agency.Id.Text = "";
            agency.Name.Text = "";
            conAgency.Id.Text = "";
            conAgency.Name.Text = "";
        ...
        public void LoadSearchParams()
        {
            try
            {
                ...
                if (searchParams.Count > 0)
                {
                    ...
                    checkBestOfPhotos.Checked = Convert.ToBoolean(GetSearchParamValue(searchParams, checkBestOfPhotos.ID, false));
                    ...
                    radioConsolidated.Checked = Convert.ToBoolean(GetSearchParamValue(searchParams, radioConsolidated.ID, false));
                    radioNonConsolidated.Checked = Convert.ToBoolean(GetSearchParamValue(searchParams, radioNonConsolidated.ID, true));
